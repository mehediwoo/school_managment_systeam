    ...
    <div class="container-fluid main-container">
        <div class="d-flex align-items-center">
            ...
            <a class="logo-horizontal " href="">
                <img src="{{ asset($logo->favicon) }}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ asset($logo->logo) }}" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
            ...
            <div class="d-flex order-lg-2 ms-auto header-right-icons">
                <div class="dropdown d-none">
                    <a href="javascript:void(0);" class="nav-link icon" data-bs-toggle="dropdown"></a>
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown  d-flex notifications">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="notifications-menu">
                                        @php
                                            $notice = App\Models\Notice::latest()->take(10)->get();
                                        @endphp

                                        @if (!empty($notice))
                                        @foreach ($notice as $row)
                                        <a class="dropdown-item d-flex" href="{{ route('notice.details',$row->id) }}">
                                            <div class="me-3 notifyimg  bg-primary brround box-shadow-primary my-auto">
                                                <img src="{{ asset($row->image) }}" alt="">
                                            </div>
                                            <div class="mt-1 wd-80p">
                                                <h5 class="notification-label mb-1">{{ $row->title }}</h5>
                                                <span class="notification-subtext">{{ date('Y-m-d, H:m',strtotime($row->date)) }}</span>
                                    ...
                                    <div class="dropdown-footer p-4">
                                        <a class="btn btn-primary btn-pill w-sm btn-sm py-2 btn-block fs-14" href="{{ route('view.all.notice') }}">View All</a>
                                    </div>
                                </div>
                            </div>
                            <!-- NOTIFICATIONS -->
                            ...
                            {{-- <div class="dropdown  d-flex message">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="dropdown-footer p-4">
                                        <a
                                            class="btn btn-primary btn-pill w-sm btn-sm py-2 btn-block fs-14"
                                            href="{{url('chat')}}">See All Messages</a>
                                    </div>
                                </div>
                            </div> --}}
                            <!-- MESSAGE-BOX -->
                            ...
                            <div class="dropdown d-flex profile-1">
                                @php
                                    ...
                                    //$branch_details= App\Models\BranchDetails::where('branch_id',Auth::user()->branch_id)->first();
                                @endphp
                                <a href="javascript:void(0);" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    @if ($branch==null)
                                    <img src="{{asset('build/assets/images/users/11.jpg')}}" alt="profile-user" class="avatar  profile-user brround cover-image">
                                    @else
                                    <img src="{{ asset($branch->branch_details->ceo_profile) ?? '' }}" alt="profile-user" class="avatar  profile-user brround cover-image">
                                    @endif
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            ...
                                            <small class="text-muted">{{ ucfirst(Auth::user()->admin_role) }}</small>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
                                    ...
                                    @else
                                    <a class="dropdown-item" href="{{ route('institute.profile.index') }}">
                                        <i class="dropdown-icon fe fe-user"></i>
                                        Profile
                                    </a>
                                    @endif
