...
@section('content')
                            ...
                            <div class="page-header">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Registration card managment</li>
                                </ol>
                            </div>
                            <!-- PAGE-HEADER END -->
                                ...
                                <div class="col-md-12">
                                    <div class="card form-input-elements">
                                        <div class="card-header">
                                            <h3 class="mb-0 card-title">Generate Registration Card</h3>
                                        </div>
    ...
    $(document).ready(function () {
        $('#filter_btn').click(function () {
            let formData = $('#search_filter').serialize();
             $.ajax({
                 url: "{{ route('registration.generate.card.student') }}",
                 type: 'GET',
                 data: formData,
