<form action="{{ route('admitCard.generate') }}" method="post">
    @csrf
<div class="card-body">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-8 text-end">
                    <div class="row">
                        <div class="col-md-8 d-flex gap-10">
                            Print Date:<input type="date" name="manual_date" class="form-control">
                            Exam Date:<input type="date" name="exam_date" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <button type="submit" class="btn btn-primary"> Admit Card Generate</button>
                        </div>
        ...
        <tbody>
            @foreach($student as $student)
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="generate_card[{{ $student->id }}]" class="student-checkbox"">
                    </td>
