...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <form action="{{ route('insert.registration') }}" method="post">
                @csrf
                <div class="card-header">
                    <div class="">
                        <button type="submit" class="btn btn-success" name="action" value="register" id="register_btn">Register</button>
                    </div>
                    <div class="">
                        <button type="button" class="btn btn-info" target="__blank" name="actions" onclick="openInNewTab()" style="margin-left: 5%" value="print">Print</button>
                    </div>
                </div>
                <div class="card-body">
...
<script>
    function openInNewTab() {
        var selectedIds = [];
        document.querySelectorAll('.branch-checkbox:checked').forEach(function(checkbox) {
